...
# Search result paths
D_search_result_folder_path = os.path.join(assets_path, 'D_search_results', 'D_search_result_raw.json')
D_final_search_result_path = os.path.join(assets_path, 'D_search_result_ra2.json')
D_aggregated_search_result_folder_path = os.path.join(assets_path, 'D_search_results', 'D_search_result_raw-aggregated-10.json')
